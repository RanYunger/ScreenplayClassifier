    ...
    public class ArchivesFilterViewModel : PropertyChangeNotifier
    {
        ...
        public string FilteredGenre
        {
            ...
            set
            {
                ...
                SubGenre1Options = new ObservableCollection<string>(MONGO.Genres);
                SubGenre1Options.Remove(filteredGenre);
                SubGenre1Options.Remove(FilteredSubGenre2);

                SubGenre2Options = new ObservableCollection<string>(MONGO.Genres);
        ...
        public string FilteredSubGenre1
        {
            ...
            set
            {
                ...
                GenreOptions = new ObservableCollection<string>(MONGO.Genres);
        ...
        private void InitOwners()
        {
            ...
            {
                OwnerOptions.Clear();
                foreach (UserModel owner in MONGO.Users)
