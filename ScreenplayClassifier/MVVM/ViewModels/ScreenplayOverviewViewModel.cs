...
namespace ScreenplayClassifier.MVVM.ViewModels
{
    public class ScreenplayOverviewViewModel : PropertyChangeNotifier
    {
        ...
        public string SelectedOwnerGenre
        {
            ...
            set
            {
                ...
                if (selectedOwnerGenre != null)
                {
                    ...
                    OwnerSubGenre1Options = new ObservableCollection<string>(DATABASE.Genres);
                    OwnerSubGenre2Options = new ObservableCollection<string>(DATABASE.Genres);
        ...
        public string SelectedOwnerSubGenre1
        {
            ...
            set
            {
                ObservableCollection<string> selectedOptions = new ObservableCollection<string>(DATABASE.Genres);
                ...
                if (selectedOwnerSubGenre1 != null)
                {
                    ...
                    // Restores options to their default collection
                    OwnerGenreOptions = new ObservableCollection<string>(DATABASE.Genres);
                    OwnerSubGenre2Options = new ObservableCollection<string>(DATABASE.Genres);
